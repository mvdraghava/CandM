...
@Component({
  selector: 'app-showloa',
  templateUrl: './showloa.component.html',
  styleUrls: ['./showloa.component.css']
})
export class ShowloaComponent implements OnInit {
  ...
  loaded() {
    ...
    for(var i = 0; i < pre_links.length; i++) {
      ...
      if(this.changereqUrl){
        this.requrl = atag.href;
        this.changereqUrl = false;
      }
      if(dir_elems[i]){
